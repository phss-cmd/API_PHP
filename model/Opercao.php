...
class Operacao
{
    ...
    function updateFrutas($campo_1, $campo_2, $campo_3, $campo_4) {
       $stmt= $this->con->prepare("update frutas_tb set nomefrutas=?, imgfruta=?, valorfruta=? where uidfruta=?");

       $stmt->bind_param("sssi", $campo_1, $campo_2, $campo_3, $campo_4);
       if($stmt ->execute())
       return true;
       return false;
    }

    function deletefruta($campo_1){
